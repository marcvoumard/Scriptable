...
class Configuration {
  ...
  jeedomBaseUrl = 'https://marcvoumard.dns4.jeedom.com/'; // location of your system running jeedom, local or external e.g. http://192.168.178.33:8581 or dns
  apiKey = 'T6AHErEkAdfTXVOxkgaI9jRwwU4hfstwl1eivTul9k3Tqqmi'; // find in Jeedom > Réglage > Système > Configuration > API
  ...
  jeedomData = {
    'header': [ // only 4 items in header MAX
      {
        'title': 'Mercedes', // title you want to display in widget
        'type': 'cmd', // type in Jeedom
        'id': 33301, // id of data you want to get from Jeedom
